...
|APNG|Animated Portable Network Graphics|rwm|
...
|MP4|VIDEO-4 Video Stream|rwm|
|MPC|Magick Pixel Cache image format|rwm|
...
|PHM|Portable half float format|rwm|
